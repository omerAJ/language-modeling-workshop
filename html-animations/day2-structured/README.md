...
| 27 | Position embeddings: learned absolute, sinusoidal, rotary |
...
Slide 27 is source-grounded and uses click-to-reveal content. The visible slide keeps citations light; the source grounding is documented here and in the slide HTML comment:
- Vaswani et al. (2017), *Attention Is All You Need* — https://ar5iv.labs.arxiv.org/html/1706.03762
- Devlin et al. (2018), *BERT* — https://ar5iv.labs.arxiv.org/html/1810.04805v2
- Su et al. (2021), *RoFormer* — https://arxiv.org/abs/2104.09864
The signal plot on slide 27 is generated by `day2-structured/tools/generate_positional_signals_svg.py` and saved to `day2-structured/assets/generated/positional-signals.svg`.

Plain-language inferences used on slide 27:
- the phase / rotation view of each sin-cos pair
- the multiscale interpretation of using many sinusoidal frequencies
- the linearity explanation \(W(x + p) = Wx + Wp\) for why adding position does not automatically erase content
...
Manual smoke test: navigation (next/back/skip/keyboard), slide 16 lens switching, slides 18–30 stepping, slide 27 autostep reveals, and slides 31–33 autostep reveals.
...
Autostep reveals: slide 27 → 2, slide 31 → 3, slide 32 → 3, slide 33 → 3.
